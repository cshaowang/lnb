...
public class ClassifierParameters implements Cloneable {
	...
	public boolean lifelongSequenceSwitch = false; // if True, "NaiveBayes_SGD_Lifelong_Sequence"
	...
	// ------------------------------------------------------------------------
	public boolean includeTargetDomainLabeledDataForTraining = true; // only training target domain
	public boolean includeSourceDomainsLabeledDataForTraining = false; // also training source domains

	// ------------------------------------------------------------------------
	// Lifelong sentiment classification.
	// ------------------------------------------------------------------------
	public double gammaThreshold = 2;
	public double positiveRatioThreshold = 3; // 3 is best fo 200 reviews; 2 is best for 1000 reviews
	                                          // zhiyuan uses 6
	public double negativeRatioThreshold = 1.0 / positiveRatioThreshold;
	public double positiveOrNegativeFrequencyThreshold = 0;
	public double regCoefficientAlpha = 0.1; // \alpha // it is reported in paper that 0.1 is good,
	// however, 0.01 is working better here.
	public int domainLevelKnowledgeSupportThreshold = 11; // 8 is best for 200 reviews; 12 is best for 1000 reviews
